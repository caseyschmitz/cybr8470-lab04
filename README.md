In this lab, you will create your first Django application and explore some of the common Django libraries and features - including url dispatchers, views (AKA controllers), and models.
